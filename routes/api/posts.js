...
router.get('/', (req, res) => {
	...
	.catch(error => res.status(404).json({posts: 'No posts found'}));
});
...
router.get('/:id', (req, res) => {
	...
	.catch(error => res.status(404).json({post: 'Post with this ID was not found'}));
});
...
// @route 	POST api/posts/removeupvote/:id
// @desc 	Remove upvote from post
// @access 	Private
